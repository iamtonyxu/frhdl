...
#######################################################################
# Set Core Clock to 156.25MHz
create_clock -period 6.40 [get_ports rx_core_clk]

# Set AXI-Lite Clock to 100.0MHz by default
create_clock -period 10.000 -name system_jesd204_rx_0_axi_aclk [get_ports s_axi_aclk]
